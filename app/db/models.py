...
class WalletAnalytic(Base):
    ...
    sharpe_ratio = Column(Numeric(28, 6), nullable=True)
    max_drawdown = Column(Numeric(28, 6), nullable=True)
    ...
    follow_score = Column(Numeric(8, 6), nullable=True)
    category_follow_scores = Column(JSONB, nullable=True)
