...
class TestCategorySpecialization:
    ...
    def test_compute(self, specialist_count, avg_rank, expected_min):
    ...
    def test_zero_specialization_no_data(self):
...
class TestRecencyScore:
    ...
    def test_recency(self, days_since, expected):
...
class TestRecommendationThresholds:
    ...
    def test_thresholds(self, score_value, expected):
